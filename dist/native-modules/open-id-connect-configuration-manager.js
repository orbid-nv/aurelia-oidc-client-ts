...
var default_1 = (function () {
    function default_1(dto) {
        ...
        this._userManagerSettings = {
            ...
            loadUserInfo: true,
            post_logout_redirect_uri: "".concat(defaultClientUri, "/signout-oidc"),
            redirect_uri: "".concat(defaultClientUri, "/signin-oidc"),
            response_type: "id_token token",
            scope: "openid email roles profile",
            silent_redirect_uri: "".concat(defaultClientUri, "/signin-oidc"),
        };
        if (!dto) {
            return;
        }
    ...
    default_1.prototype.ensureRouteValueBeginsWithSlash = function (key, val) {
        if (key.endsWith("Route") && !val.startsWith("/")) {
            var message = "The configured \"".concat(key, "\" must begin with a slash");
